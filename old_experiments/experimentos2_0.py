...
df_fakes['processed_text'] = df_fakes['text'].apply(preprocessing, args=('portuguese',)) 
df_fakes_lupa['processed_text'] = df_fakes_lupa['text'].apply(preprocessing, args=('portuguese',)) 
...
df_all_boatos = pd.concat([df_fakes[['text','processed_text','classification','words_count',
                                    'caracters_count','sentences_count','characters_per_word_avg',
                                    'words_per_sentence_avg','punctuations_per_sentence']], 
                    df_true[['text','processed_text','classification','words_count',
                                    'caracters_count','sentences_count','characters_per_word_avg',
                                    'words_per_sentence_avg','punctuations_per_sentence']].iloc[:2555,:],
                    ])

datasets_dict = {
    'Boatos_Lupa': df_all_boatos_lupa,
    'Boatos': df_all_boatos,
    'Lupa': df_fakes_lupa
}
...
def run_experiments(hyperparameters = None,*,datasets, ds_type, gs_flag, classifier, 
  ...
  vectorizations = ['Frequency Vectors', 'TF-IDF', 'Word2Vec']
  dataset_type = ''
  grid_search = ''
  with_preprocessing = ''
  ...
  if ds_type == "lupa":
    dataset = datasets['Boatos_Lupa']
    dataset_type = 'Boatos + Lupa'
  elif ds_type == 'boatos':
    dataset = datasets['Boatos']
    dataset_type = 'Boatos'
...
# run_experiments(datasets=datasets_dict, 
#                 ds_type='lupa', 
#                 gs_flag=True,
